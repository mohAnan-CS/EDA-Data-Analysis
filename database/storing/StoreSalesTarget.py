...
def store_sales_target(sales_outlet_id, year_month_date, beans_goal, beverage_goal, food_goal, merchandise_goal, total_goal, cursor, mydb):
    insert_sales_target_sql = "insert into sales_target (sales_outlet_id, year_month_date, beans_goal, beverage_goal, food_goal, merchandise_goal, total_goal) VALUES (%s, %s, %s, %s, %s, %s, %s)"
